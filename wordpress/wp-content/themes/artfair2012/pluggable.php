...
function wp_new_user_notification($user_id, $plaintext_pass = '') {
	...
	if ( empty($plaintext_pass) )
		return;
	$message  = sprintf(__('Hello and welcome to Art Fair Scavenger Hunt!')) . "\r\n\r\n";
	$message .= sprintf(__('here is your login information:')) . "\r\n\r\n";

	$message .= sprintf(__('Username: %s'), $user_login) . "\r\n";
	$message .= sprintf(__('Password: %s'), $plaintext_pass) . "\r\n";
	//$message .= wp_login_url() . "\r\n";
	$message .= "http://artfairscavengerhunt.com/login" . "\r\n";

	wp_mail($user_email, sprintf(__('Welcome to Art Fair Scavenger Hunt'), $blogname), $message);
